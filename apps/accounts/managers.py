"""
Custom User Manager untuk handle email sebagai username.
"""
...
class CustomUserManager(BaseUserManager):
    """
    Custom user model manager dimana email adalah unique identifier
    untuk authentication, bukan username.
    """
